...
while ($row = mysqli_fetch_array($result));
	...
	?>
				...
				<ul id="reactor-grid">
   		      	          <?php
                          if (isset($_GET['idSbornik']))
                          {
                            echo $_GET['idSbornik']."<br>";
                            
                          }

   $result = mysqli_query($db,  "SELECT * FROM sborniki WHERE idSbornik='$idencefic'");
...
$heidht = 200;
		...
		<div class="shoe-in"> <a href= "Sbornik_Description.php?idSbornik='.$row["idSbornik"].'&TypeApparatus='.$row["mini_description"].'""> '.$row["Name"].'</a> </p>
...
?>     
  <?php
                          if (isset($_POST['idSbornik']))
                          {
                            echo $_POST['idSbornik']."<br>";
