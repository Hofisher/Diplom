...
$result = mysqli_query($db,"SELECT Model, cost, weight, height, lenght, widht, factor_separation, power, max_load from centrifugi as c WHERE $query_series");
...
echo '<p><input type="button" value="Выбрать альтернативу" onclick=""></p>';
