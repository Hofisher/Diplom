...
while ($row = mysqli_fetch_array($result));
	...
	?>
				...
				<ul id="reactor-grid">
   		      	          <?php
                          if (isset($_GET['idSushilki']))
                          {
                            echo $_GET['idSushilki']."<br>";
                            
                          }

   $result = mysqli_query($db,  "SELECT * FROM sushilki WHERE idSushilki='$idencefic'");
...
?>     
  <?php
                          if (isset($_POST['idSushilki']))
                          {
                            echo $_POST['idSushilki']."<br>";
