...
?>
   ...
   $result = mysqli_query($db,  "SELECT * FROM filter WHERE visible='1' $querycat"); 
...
$heidht = 200;
		...
		<div class="shoe-in"> <a href= ""> '.$row["NameFilter"].'</a> </p>
		 <a class="add-cart-style-grid"> </a>
		 <p class="style-price-grid"><strong>'.$row["CostFilter"].'</strong>руб.</p>
		 <h6><a href="single.php"class="store"><div class="mini-description">'.$row["Mini_descriptionFilter"].'</div>
			 </a></h6>
			   </div>
			   			  </div>  
		 </li>
