...
if(isset($_POST['equipment']) && $_POST['equipment'] == "centrifuges"){
					...
					<p><input type="file" name="myf" value="Фотография (.jpg, .png)"/></P> 
...
';
		    ...
		    echo'<input type=submit name=add placeholder="добавить в каталог" formaction="add_info.php" enctype="multipart/form-data"/>';
